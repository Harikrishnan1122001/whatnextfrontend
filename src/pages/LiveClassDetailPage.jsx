...
//             <span>👥 {cls.registrations?.length || 0} / {cls.maxParticipants || 100} registered</span>
//           </div>
//         </div>
//       </div>
...
//             ) : (
//               <button className="btn btn-primary sidebar-btn btn-lg" onClick={handleRegister} disabled={buying || cls.status === 'completed'}>
//                 {buying ? 'Processing…' : cls.status === 'completed' ? 'Class Ended' : cls.isFree || cls.price === 0 ? '🚀 Register Free' : `💳 Register ₹${cls.price}`}
//               </button>
//             )}
...
//                 ['👥', `${cls.availableSeats || (cls.maxParticipants - (cls.registrations?.length || 0))} seats left`],
//               ].map(([icon, text]) => (
